...
|--------------|----------------------------------------------------------|--------------------------------|
| API URL      | Base URL of the `external_payments` service              | `https://checkout.kbb1.com`   |
| Organization | Organization code (`ben2` or `meshp18`)                 | `ben2`                         |
| SKU          | Product SKU sent to Priority ERP                        | `WOO`                          |
